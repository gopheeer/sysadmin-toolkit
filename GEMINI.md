...
- **The Arsenal Command:** An interactive, `fzf`-powered cheatsheet (`arsenal`) for exploring the toolkit's capabilities, now including multiple concise usage hints and examples for each tool.
